...
cargo binstall ripgrep         -y --version 14.1.1
cargo binstall bat             -y --version 0.25.0
cargo binstall exa             -y --version 0.10.1
...
cargo binstall tree-sitter-cli -y --version 0.24.7
